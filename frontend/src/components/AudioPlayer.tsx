      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-2">
            <span className="text-ranting-ice text-sm font-mono">{formatTime(currentTime)}</span>
            ...
            <span className="text-ranting-muted text-sm font-mono">{formatTime(duration)}</span>
          </div>
        </div>
