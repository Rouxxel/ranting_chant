        ...
        {requests.map((r) => (
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <Avatar name={r.tenant_name || r.requester_id || "Unknown"} size={22} glow={false} />
              <span className="truncate">{r.tenant_name || r.requester_id || "Unknown"}</span>
            </div>
            ...
            <div className="text-xs text-ranting-muted">
            ...
            <div onClick={(e) => e.stopPropagation()}>
              {r.status === "pending_approval" ? (
                <button
                  ...
                  className="glossy-btn-green inline-flex items-center gap-1 px-2.5 py-1 text-xs"
                >
                ...
                <button
                  onClick={() => onRowClick(r)}
                  className="glossy-btn-ghost px-2.5 py-1 text-xs"
                >
                  View
                </button>
              )}
